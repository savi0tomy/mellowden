...
</head><body><header><div class="head"><div class="brand">MELLOWDEN</div><a class="logout" href="/admin/logout">Sign out</a></div></header><main><div class="hero"><div><h1>Portrait orders</h1><div class="sub">Upload artwork, automatically email review links, and track approvals or revision requests.</div></div></div>{flash}{error_flash}{empty}{''.join(cards)}</main></body></html>"""
